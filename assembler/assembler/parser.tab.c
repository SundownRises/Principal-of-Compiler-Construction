...
static const yytype_int8 yyrhs[] =
{
      10,     0,    -1,    11,    -1,    12,    -1,    11,    12,    -1,
       6,    -1,    13,    14,     6,    -1,    14,     6,    -1,     3,
       7,    -1,     3,    -1,     3,    15,    -1,    16,    -1,    15,
       8,    16,    -1,     3,    -1,     4,    -1,     5,    -1
};
...
{
  "$end", "error", "$undefined", "IDENTIFIER", "REGISTER", "NUMBER",
  "NEWLINE", "COLON", "COMMA", "$accept", "program", "line_list", "line",
  "label", "instruction", "operand_list", "operand", 0
};
#endif
...
{
       0,     9,     5,     0,     2,     3,     0,     0,    13,    14,
      15,     8,    10,    11,     1,     4,     9,     0,     7,     0,
       6,    12
};
...
{
       8,     9,    10,     1,    11,    14,     2,     8,     9,    10,
      16,    19,    18,    15,    20,    21,    17
};
...
{
       0,     3,     6,    10,    11,    12,    13,    14,     3,     4,
       5,     7,    15,    16,     0,    12,     3,    14,     6,     8,
       6,    16
};
...
#line 55 "parser.y"
    {
        if (pass == 1) {
            add_symbol((yyvsp[(1) - (2)].str), location_counter);
        }
        free((yyvsp[(1) - (2)].str));
    ;}
    break;
...
#line 64 "parser.y"
    {
        if (pass == 1) {
            add_symbol((yyvsp[(1) - (1)].str), location_counter);
        }
        int opcode = get_opcode((yyvsp[(1) - (1)].str));
        if (pass == 2) {
            printf("%02X ", opcode);
        }
        location_counter += 1;
...
#line 76 "parser.y"
    {
        int opcode = get_opcode((yyvsp[(1) - (2)].str));
        if (pass == 2) {
            printf("%02X ", opcode);
        }
        location_counter += 1;
...
#line 90 "parser.y"
    {
        if (pass == 2) {
            int address = find_symbol((yyvsp[(1) - (1)].str));
            if (address == -1) {
...
#line 103 "parser.y"
    {
        if (pass == 2) {
            int reg_code = get_register_code((yyvsp[(1) - (1)].str));
            printf("%02X ", reg_code);
        }
        location_counter += 1;
        free((yyvsp[(1) - (1)].str));
